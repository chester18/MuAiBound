...
public class ListTrainingActivity extends CBaseActivity {
    ...
    BaseAdapter adapter=new BaseAdapter() {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            TrainingModel model= (TrainingModel) dataList.get(i);
            IcoCell cell=new IcoCell(ListTrainingActivity.this);
            cell.setModel(new DetailCellModel(null,null,model.OrganizationName,model.TrainingDuring,"{md-chevron-right}"));
    ...
    {
        Intent intent=new Intent(this,DetailTrainingActivity.class);
        intent.putExtra("model",(TrainingModel)dataList.get(position));
        startActivity(intent);
    }
    @Override
    ...
    private void loadingData()
    {
        ...
        sendPost(CommonNetString.userReadTraining,ojs,"读取培训记录...",1);
    }
    ...
    protected void getResult(String result, int tag) {
        ...
        if (jo.get("result").getAsInt()==1)
        {
            ...
            {
                dataList.add(new TrainingModel(array.get(i).getAsJsonObject()));
            }
