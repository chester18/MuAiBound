...
public class DetailTrainingActivity extends CBaseActivity {
    ...
    TrainingModel model;            //数据模型
    String updataUrl;               //上传地址
    String[] mainTitle={"培训机构:","培训名称:","培训科目:","培训等级:","培训结果:","证书照片:","培训周期",""};
    String[] keys={"OrganizationName","TrainingContent","TrainingObject","TrainingGrade","TrainingResult","TrainingImg","TrainingDuring"};
    BaseAdapter adapter=new BaseAdapter() {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            {
                ButtonCell bcell=new ButtonCell(DetailTrainingActivity.this);
            ...
            IcoCell cell=new IcoCell(DetailTrainingActivity.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        model= (TrainingModel) getIntent().getSerializableExtra("model");
        if (model==null)
        {
            model=new TrainingModel(new JsonObject());
        ...
        switch (position){
            case 0:
            {
                BaseDialog bd= DialogFactry.instance(this, DialogFactry.DIA_INPUT, 0, mainTitle[position], "", new DialogCallBackInterface() {
                    ...
                    public void selectShure(int tag, Object result) {
                        model.OrganizationName=result.toString();
            ...
            case 1:
            {
                BaseDialog bd= DialogFactry.instance(this, DialogFactry.DIA_INPUT, 1, mainTitle[position], "", new DialogCallBackInterface() {
                    @Override
                    public void selectShure(int tag, Object result) {
                        model.TrainingContent=result.toString();
                        adapter.notifyDataSetChanged();
                    }
            ...
            case 2:
            {
                BaseDialog bd= DialogFactry.instance(this, DialogFactry.DIA_INPUT, 2, mainTitle[position], "", new DialogCallBackInterface() {
                    @Override
                    public void selectShure(int tag, Object result) {
                        model.TrainingObject=result.toString();
                        adapter.notifyDataSetChanged();
                    }
            ...
            case 3:
            {
                BaseDialog bd= DialogFactry.instance(this, DialogFactry.DIA_DATE, 3, mainTitle[position], "", new DialogCallBackInterface() {
                    @Override
                    public void selectShure(int tag, Object result) {
                        model.TrainingGrade=result.toString();
                        adapter.notifyDataSetChanged();
                    }
            ...
            case 4:
            {
                BaseDialog bd= DialogFactry.instance(this, DialogFactry.DIA_DATE, 3, mainTitle[position], "", new DialogCallBackInterface() {
                    @Override
                    public void selectShure(int tag, Object result) {
                        model.TrainingResult=result.toString();
                        adapter.notifyDataSetChanged();
                    }
            ...
            case 6:
            {
                BaseDialog bd= DialogFactry.instance(this, DialogFactry.DIA_DATE, 6, mainTitle[position], "", new DialogCallBackInterface() {
                    @Override
                    public void selectShure(int tag, Object result) {
                        model.TrainingDuring=result.toString();
                        adapter.notifyDataSetChanged();
                    }
    ...
    protected void getResult(String result, int tag) {
        ...
        if (tag==5)
        {
            ...
            if (jo.get("result").getAsInt()==1)
            {
                ...
                model.TrainingImg=img.get("name").getAsString();
                adapter.notifyDataSetChanged();
            }else {
