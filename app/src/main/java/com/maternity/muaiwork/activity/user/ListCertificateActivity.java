...
public class ListCertificateActivity extends CBaseActivity {
    ...
    BaseAdapter adapter=new BaseAdapter() {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            CertificateModel model= (CertificateModel) dataList.get(i);
            IcoCell cell=new IcoCell(ListCertificateActivity.this);
            cell.setModel(new DetailCellModel(null,null,model.CertificateName,model.Organization,"{md-chevron-right}"));
    ...
    {
        Intent intent=new Intent(this,DetailCertificateActivity.class);
    ...
    {
        Intent intent=new Intent(this,DetailCertificateActivity.class);
        intent.putExtra("model",(CertificateModel)dataList.get(position));
        startActivity(intent);
    }
    @Override
    ...
    private void loadingData()
    {
        ...
        sendPost(CommonNetString.userReadCertificate,ojs,"读取证书记录...",1);
    }
    ...
    protected void getResult(String result, int tag) {
        ...
        if (jo.get("result").getAsInt()==1)
        {
            ...
            {
                dataList.add(new CertificateModel(array.get(i).getAsJsonObject()));
            }
