...
public class NeedDetailActivity extends CBaseActivity {

    @ViewInject(R.id.order_detail_list)
    ListView infoList;
//    @ViewInject(R.id.order_custom_view)
            ...
            if (needInfoModel!=null)
                switch (i)
                {
                    case 0:
                        ...
                        cell=new DetailCell(NeedDetailActivity.this);
                    ...
                    case 6:
                        ...
                        break;
                    case 7:
                        MoreDetailCell md=new MoreDetailCell(NeedDetailActivity.this);
                ...
                cell.setLayoutParams(new AbsListView.LayoutParams(screenWidth, ViewGroup.LayoutParams.WRAP_CONTENT));
            return cell;
        }
    };


    NeedInfoModel needInfoModel=new NeedInfoModel();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        x.view().inject(this);
        needInfoModel= (NeedInfoModel) getIntent().getSerializableExtra("data");
//        needInfoModel=new NeedInfoModel();
