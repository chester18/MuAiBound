...
public class ListInsurancePolicyActivity extends CBaseActivity {
    ...
    BaseAdapter adapter=new BaseAdapter() {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            InsurancePolicyModel model= (InsurancePolicyModel) dataList.get(i);
            IcoCell cell=new IcoCell(ListInsurancePolicyActivity.this);
            cell.setModel(new DetailCellModel(null,null,model.PolicyNo,model.ExpiryDate,"{md-chevron-right}"));
    ...
    {
        Intent intent=new Intent(this,DetailInsurancePolicyActivity.class);
    ...
    {
        Intent intent=new Intent(this,DetailInsurancePolicyActivity.class);
        intent.putExtra("model",(InsurancePolicyModel)dataList.get(position));
        startActivity(intent);
    }
    @Override
    ...
    private void loadingData()
    {
        ...
        sendPost(CommonNetString.userReadInsurance,ojs,"读取保险记录...",1);
    }
    ...
    protected void getResult(String result, int tag) {
        ...
        if (jo.get("result").getAsInt()==1)
        {
            ...
            {
                dataList.add(new InsurancePolicyModel(array.get(i).getAsJsonObject()));
            }
