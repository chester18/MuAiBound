...
public class ListServerExperienceActivity extends CBaseActivity {
    ...
    BaseAdapter adapter=new BaseAdapter() {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ServerExperienceModel model= (ServerExperienceModel) dataList.get(i);
            IcoCell cell=new IcoCell(ListServerExperienceActivity.this);
            cell.setModel(new DetailCellModel(null,null,model.ServerObject,model.ServerDuring,"{md-chevron-right}"));
    ...
    {
        Intent intent=new Intent(this,DetailServerExperienceActivity.class);
    ...
    {
        Intent intent=new Intent(this,DetailServerExperienceActivity.class);
        intent.putExtra("model",(ServerExperienceModel)dataList.get(position));
        startActivity(intent);
    }
    @Override
    ...
    private void loadingData()
    {
        ...
        sendPost(CommonNetString.userReadServer,ojs,"读取服务记录...",1);
    }
    ...
    protected void getResult(String result, int tag) {
        ...
        if (jo.get("result").getAsInt()==1)
        {
            ...
            {
                dataList.add(new ServerExperienceModel(array.get(i).getAsJsonObject()));
            }
